...
public class ItemMaskAnbu1 extends ElementsNarutomodMod.ModElement {
	...
	public static class ModelAnbuMask extends ModelBiped {
		...
		public ModelAnbuMask() {
			...
			bone4.setRotationPoint(-2.911F, 0.0F, 0.4F);
			band.addChild(bone4);
			setRotationAngle(bone4, 0.2618F, 0.0F, 0.2618F);
			bone4.cubeList.add(new ModelBox(bone4, 0, 0, -1.0F, -4.0F, 0.0F, 2, 8, 0, 0.0F, true));
			bone3 = new ModelRenderer(this);
			bone3.setRotationPoint(0.0F, 0.0F, 0.4F);
			band.addChild(bone3);
			setRotationAngle(bone3, 0.2618F, 0.0F, -0.2618F);
			bone3.cubeList.add(new ModelBox(bone3, 0, 0, -1.0F, -4.0F, 0.0F, 2, 8, 0, 0.0F, false));
			catears = new ModelRenderer(this);
			catears.setRotationPoint(0.0F, 24.2F, 0.0F);
			...
			cube_r1.cubeList.add(new ModelBox(cube_r1, 24, 0, -1.5F, -1.5F, -0.5F, 3, 3, 1, 0.0F, false));
			...
			cube_r2.cubeList.add(new ModelBox(cube_r2, 24, 0, -1.5F, -1.5F, -0.5F, 3, 3, 1, 0.0F, true));
			horns = new ModelRenderer(this);
			horns.setRotationPoint(-2.5F, -7.0F, -4.5F);
			...
			setRotationAngle(cube_r3, -0.5213F, -0.6385F, 0.0751F);
			cube_r3.cubeList.add(new ModelBox(cube_r3, 23, 22, -0.175F, -0.35F, -1.5F, 1, 1, 3, 0.2F, true));
			cube_r4 = new ModelRenderer(this);
			cube_r4.setRotationPoint(1.8582F, -3.9999F, -1.5468F);
			bone8.addChild(cube_r4);
			setRotationAngle(cube_r4, -1.2194F, -0.6385F, 0.0751F);
			cube_r4.cubeList.add(new ModelBox(cube_r4, 23, 22, -0.5F, 0.1F, 0.95F, 1, 1, 3, -0.1F, true));
			...
			cube_r5.cubeList.add(new ModelBox(cube_r5, 23, 22, -0.825F, -0.35F, -1.5F, 1, 1, 3, 0.2F, false));
			...
			cube_r6.cubeList.add(new ModelBox(cube_r6, 23, 22, -0.5F, 0.1F, 0.95F, 1, 1, 3, -0.1F, false));
