...
public class EntityGuren extends ElementsNarutomodMod.ModElement {
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class RenderCustom extends EntityNinjaMob.RenderBase<EntityCustom> {
			private final ResourceLocation texture = new ResourceLocation("narutomod:textures/guren.png");

			public RenderCustom(RenderManager renderManagerIn) {
				super(renderManagerIn, new ModelGuren());
			}
		...
		@SideOnly(Side.CLIENT)
		public class ModelGuren extends EntityNinjaMob.ModelNinja {
