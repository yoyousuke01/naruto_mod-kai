	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class ModelPainHuman extends EntityNinjaMob.ModelNinja {
			...
			public ModelPainHuman() {
				...
				bone2.cubeList.add(new ModelBox(bone2, 50, 0, -1.0F, 0.0F, -2.0F, 3, 0, 8, 0.0F, false));
				ModelRenderer bone3 = new ModelRenderer(this);
				bone3.setRotationPoint(3.35F, -6.6F, -2.0F);
				bipedHead.addChild(bone3);
				setRotationAngle(bone3, 0.0F, 0.0F, 0.7854F);
				bone3.cubeList.add(new ModelBox(bone3, 50, 0, -2.0F, 0.0F, -2.0F, 3, 0, 8, 0.0F, true));
