...
public class EntityNinjaSuna extends ElementsNarutomodMod.ModElement {
	...
	public static class EntityCustom extends EntityNinjaMob.Base {
		...
		public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
			this.setItemStackToSlot(EntityEquipmentSlot.HEAD, new ItemStack(ItemNinjaArmorSuna.helmet));
			this.setItemStackToSlot(EntityEquipmentSlot.CHEST, new ItemStack(ItemNinjaArmorSuna.body));
			this.setItemStackToSlot(EntityEquipmentSlot.LEGS, new ItemStack(ItemNinjaArmorSuna.legs));
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class RenderCustom extends EntityNinjaMob.RenderBase<EntityCustom> {
			private final ResourceLocation texture = new ResourceLocation("narutomod:textures/ninja_suna.png");

			public RenderCustom(RenderManager renderManagerIn) {
				super(renderManagerIn, new ModelSunaNinja());
			}
		...
		@SideOnly(Side.CLIENT)
		public class ModelSunaNinja extends EntityNinjaMob.ModelNinja {
			public ModelSunaNinja() {
				super();
