			...
			public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
				if ((((entity instanceof EntityPlayer) ? ((EntityPlayer) entity).capabilities.isCreativeMode : false)
					...
					((EntityPlayer) entity).sendStatusMessage(new TextComponentTranslation("chattext.cooldown.formatted",
							(entity.getEntityData().getDouble("ice_dome_cd") - NarutomodModVariables.world_tick) / 20), true);
				}
				return false;
			}
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class ModelDome extends ModelBase {
			...
			public ModelDome() {
				...
				setRotationAngle(bone5, 0.0F, -2.3562F, 0.0F);bone5.cubeList.add(new ModelBox(bone5, -8, 0, -4.0F, 0.0F, 4.75F, 8, 0, 8, 0.0F, false));
