...
public class EntityC1 extends ElementsNarutomodMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EC.class).id(new ResourceLocation("narutomod", "c_1"), ENTITYID).name("c_1")
	...
	public static class EC extends ItemBakuton.ExplosiveClay {
		...
		public boolean attackEntityAsMob(Entity entityIn) {
			...
			if (!this.world.isRemote) {
				this.world.createExplosion(owner, entityIn.posX, entityIn.posY, entityIn.posZ, 4f,
		 ...
		 * entity, float powerIn) { EC c1 = new EC(entity); Vec3d vec =
		 * entity.getLookVec(); vec = entity.getPositionVector().addVector(vec.x, 1d,
		 * vec.z); c1.setPosition(vec.x, vec.y, vec.z); entity.world.spawnEntity(c1);
		 * return true; } }
		 */
	}
	@Override
