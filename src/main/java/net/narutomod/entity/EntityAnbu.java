...
import net.narutomod.item.ItemAnbuRobe;
import net.narutomod.item.ItemAnbuSword;
import net.narutomod.item.ItemNinjaArmorAnbu;
import net.narutomod.item.ItemMaskAnbu1;
import net.narutomod.item.ItemMaskAnbu2;
import net.narutomod.item.ItemMaskAnbu3;
import net.narutomod.item.ItemMaskAnbu4;
import net.narutomod.item.ItemMaskAnbu5;
import net.narutomod.item.ItemMaskAnbu6;
...
public class EntityAnbu extends ElementsNarutomodMod.ModElement {
	...
	public static class EntityCustom extends EntityNinjaMob.Base {
		...
		public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
			Item[] mask = { ItemMaskAnbu1.helmet, ItemMaskAnbu2.helmet, ItemMaskAnbu3.helmet, ItemMaskAnbu4.helmet, ItemMaskAnbu5.helmet, ItemMaskAnbu6.helmet };
			this.setItemStackToSlot(EntityEquipmentSlot.HEAD, new ItemStack(mask[this.rand.nextInt(6)]));
			this.setItemStackToSlot(EntityEquipmentSlot.CHEST, new ItemStack(this.rand.nextBoolean() ? ItemNinjaArmorAnbu.body : ItemAnbuRobe.body));
			this.setItemStackToSlot(EntityEquipmentSlot.LEGS, new ItemStack(ItemNinjaArmorAnbu.legs));
			this.setItemToInventory(new ItemStack(ItemAnbuSword.block), 0);
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class RenderCustom extends EntityNinjaMob.RenderBase<EntityCustom> {
			private final ResourceLocation texture = new ResourceLocation("narutomod:textures/ninja_anbu.png");

			public RenderCustom(RenderManager renderManagerIn) {
				super(renderManagerIn, new ModelAnbu());
			}
		...
		@SideOnly(Side.CLIENT)
		public class ModelAnbu extends EntityNinjaMob.ModelNinja {
			public ModelAnbu() {
				super();
